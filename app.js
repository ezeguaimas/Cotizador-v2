function calcular() {
  ...
  // let sueldoBruto2 = (aporte3 + aporte4) / 0.03;
    ...
    document.getElementById("dif_corp").textContent = typeof renderCorp === 'number' ? renderCorp.toFixed(2) : renderCorp;
    document.getElementById("dif_vip").textContent = typeof renderVip === 'number' ? renderVip.toFixed(2) : renderVip;
}
